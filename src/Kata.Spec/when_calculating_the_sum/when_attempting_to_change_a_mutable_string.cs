...
namespace Kata.Spec.when_calculating_the_sum
{
    ...
    public class when_input_has_a_negative_number
    {
        ...
        It should_return_an_exception_with_that_number = () =>
        {
    ...
    public class when_input_has_multiple_negatives
    {
        ...
        It should_throw_an_exception_that_lists_them = () =>
        {
            _result.Message.Should().Be("negatives not allowed: -3, -4, -5");
        };
    ...
    public class when_input_has_multi_char_delimiter
    {
        Establish _context = () =>
        {
    ...
    public class when_input_has_multiple_custom_separators
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
